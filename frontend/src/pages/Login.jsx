...
import { setCredentials, setMFARequired } from "../store/authSlice";
...
const Login = () => {
  ...
  const { userInfo, mfaRequired } = useSelector((state) => state.auth);
                  ...
                  <div className="group">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        required
                        className="w-full bg-white/[0.03] border border-white/10 text-white rounded-2xl py-4 l-12 pr-4 outline-none focus:border-indigo-500/50 focus:bg-white/[0.06] transition-all font-bold placeholder:text-slate-700"
                      />
                    </div>
                  </div>
                </div>
