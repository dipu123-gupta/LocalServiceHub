      ...
      <div className="max-w-7xl mx-auto px-4 mt-12">
        <div className="flex flex-col lg:flex-row gap-12 items-start">
          ...
          <div className="flex-1 space-y-12">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
                  {service.images.slice(0, 8).map((img, i) => (
                    <motion.div
                      ...
                      className="aspect-[4/3] rounded-3xl overflow-hidden bg-slate-100 border border-slate-50 cursor-pointer group"
                    >
                      <img
            ...
            <section className="bg-white rounded-[2.5rem] p-10 border border-slate-100 shadow-sm relative overflow-hidden">
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-3 mb-8">
                  ...
                  <div>
                    <h3 className="text-2xl font-black text-slate-900">Service Overview</h3>
                    <p className="text-slate-400 text-sm font-bold uppercase tracking-wider">Premium Package Details</p>
                  </div>
                </div>
                ...
                {service.features?.length > 0 && (
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {service.features.map((f, i) => (
                      <div
                        key={i}
                        className="flex items-center gap-4 p-5 bg-slate-50 rounded-[1.5rem] border border-slate-100 group hover:border-indigo-100 hover:bg-white transition-all duration-300"
                      >
                        <div className="w-8 h-8 rounded-full bg-emerald-100 flex items-center justify-center shrink-0 group-hover:bg-emerald-500 group-hover:text-white transition-colors">
                          <CheckCircle size={16} className="text-emerald-600 group-hover:text-white" />
                        </div>
            ...
            {service.provider && (
              <section className="bg-white rounded-[2.5rem] p-10 border border-slate-100 shadow-sm transition-all hover:shadow-xl hover:shadow-indigo-50/50 group">
                <div className="flex flex-col md:flex-row gap-8 items-start">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      <h4 className="text-2xl font-black text-slate-900">{service.provider.businessName}</h4>
                      <div className="px-3 py-1 bg-emerald-50 text-emerald-600 text-[10px] font-black uppercase tracking-widest rounded-lg border border-emerald-100">Verified Professional</div>
                    </div>
                    <p className="text-slate-500 font-semibold mb-6 leading-relaxed max-w-xl">
                      {service.provider.businessDescription}
                    </p>
                    <div className="flex flex-wrap gap-4">
                      <div className="flex items-center gap-2 px-4 py-2 bg-slate-50 rounded-xl text-xs font-black text-slate-600 border border-slate-100">
                        <Award size={14} className="text-indigo-500" /> Top Rated Expert
                      </div>
                      <div className="flex items-center gap-2 px-4 py-2 bg-slate-50 rounded-xl text-xs font-black text-slate-600 border border-slate-100">
                        <Shield size={14} className="text-emerald-500" /> Licensed Provider
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <aside className="lg:w-[420px] shrink-0 sticky top-24 pb-8">
            <ServiceBookingCard
              service={service}
              userInfo={userInfo}
            ...
            <div className="mt-8 grid grid-cols-2 gap-4">
              <div className="bg-white p-6 rounded-[2rem] border border-slate-100 text-center flex flex-col items-center gap-3">
                <div className="w-12 h-12 rounded-2xl bg-slate-50 flex items-center justify-center">
                  <ShieldCheck size={24} className="text-indigo-600" />
                </div>
                <div>
                  <h5 className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-1">Payment Security</h5>
                  <p className="text-xs font-bold text-slate-900">256-bit SSL Layer</p>
                </div>
              </div>
              <div className="bg-white p-6 rounded-[2rem] border border-slate-100 text-center flex flex-col items-center gap-3">
                <div className="w-12 h-12 rounded-2xl bg-slate-50 flex items-center justify-center">
                ...
                <div>
                  <h5 className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-1">Quality Guaranteed</h5>
