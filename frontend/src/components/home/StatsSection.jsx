  ...
  return (
    <section className="relative z-20 px-6">
      <div className="max-w-6xl mx-auto -mt-20">
        <div className="grid grid-cols-2 md:grid-cols-4 bg-white shadow-[0_30px_60px_-15px_rgba(0,0,0,0.1)] rounded-[3rem] p-4 border border-slate-100">
          {stats.map((s, i) => (
            <motion.div
              key={i}
              ...
              className={`relative p-8 text-center group ${
                i < stats.length - 1 ? "md:after:content-[''] md:after:absolute md:after:right-0 md:after:top-1/2 md:after:-translate-y-1/2 md:after:h-12 md:after:w-[1px] md:after:bg-slate-100" : ""
              }`}
            >
